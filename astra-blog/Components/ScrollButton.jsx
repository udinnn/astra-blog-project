// filepath: d:\Bintang\Project\astra-blog-project\astra-blog\Components\ScrollButton.jsx
"use client";

const ScrollButton = () => {
  const handleScroll = () => {
    window.scrollBy({
      top: window.innerHeight * 1, // Scroll down by 1.5 times the viewport height
      behavior: "smooth",
    });
  };
