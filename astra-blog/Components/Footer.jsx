...
const Footer = () => {
  ...
  return (
    <div className="flex flex-col w-full justify-center items-center bg-blue-800">
      <footer className="flex w-full flex-row md:flex-row items-center justify-around space-x-8 py-4 text-center text-white">
        ...
        <ul className="flex flex-row space-x-8 text-sm font-medium">
          <li>
            <a
              href="/"
              className="transition-colors hover:text-blue-400 focus:text-blue-400"
            >
              AORTA
            </a>
          </li>
          ...
          <li>
            <a
              ...
              className="transition-colors hover:cursor-pointer hover:text-blue-400 focus:text-blue-400"
            >
              Admin
            </a>
          </li>
        ...
        <div className="flex flex-row justify-center items-center space-x-4">
          ...
          <a
            ...
            className="text-blue-gray-100 hover:text-blue-500 transition-colors"
          >
            <svg
      ...
      {/* Copyright */}
      <p className="w-full bg-black/50 text-white text-sm py-2 text-center">
