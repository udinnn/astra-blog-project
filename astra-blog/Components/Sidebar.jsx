        ...
        <div className="flex flex-col">
          ...
          >
            <svg
              ...
              className="m-2"
            >
              <path d="M 21 7 V 4 a 1 1 0 0 0 -1 -1 H 15 a 1 1 0 0 0 -1 1 V 7 a 1 1 0 0 0 1 1 h 5 A 1 1 0 0 0 21 7 Z M 10 20 V 17 a 1 1 0 0 0 -1 -1 H 4 a 1 1 0 0 0 -1 1 v 3 a 1 1 0 0 0 1 1 H 9 A 1 1 0 0 0 10 20 Z M 9 12 H 4 a 1 1 0 0 1 -1 -1 V 4 A 1 1 0 0 1 4 3 H 9 a 1 1 0 0 1 1 1 v 7 A 1 1 0 0 1 9 12 Z m 12 8 V 13 a 1 1 0 0 0 -1 -1 H 15 a 1 1 0 0 0 -1 1 v 7 a 1 1 0 0 0 1 1 h 5 A 1 1 0 0 0 21 20 Z" />
            </svg>
            <p className="text-md text-white">Dashboard</p>
          </div>
