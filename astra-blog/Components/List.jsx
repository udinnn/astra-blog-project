    ...
    <div>
      <div className="flex flex-row justify-between items-center mb-4 w-auto">
        ...
        <div className="flex flex-row justify-between items-center">
          ...
          />
          <button className="text-sm bg-blue-500 text-white p-1 rounded-lg ml-2">
            Search
          </button>
        </div>
      </div>
      ...
      {/* Content Row */}
      <div className="w-auto flex flex-row mx-20 border-b-2 border-black-75 p-2 text-center text-sm">
